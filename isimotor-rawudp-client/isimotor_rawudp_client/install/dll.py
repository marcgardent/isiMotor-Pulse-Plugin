"""
DLL resolution and installation workflow for the isiMotor_RawUDP plugin.
...
def install_plugin(
    ...
    if not targets:
        ...
        logger.warning('   python -m isimotor_rawudp_client.install.cli --target-dir "/path/to/game"')
        return False
