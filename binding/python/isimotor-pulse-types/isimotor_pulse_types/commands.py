...
class HWControlCommand:
    ...
    control_name: str = ""
    """Control name (e.g. "PitMenuUp", "TCIncrease", "ABSDecrease")."""
    control_value: float = 1.0
    """1.0 for press/trigger, 0.0 for release."""
    duration_ms: int = 50
    """Pulse duration in ms (default 50ms)."""
...
class WeatherControlCommand:
    ...
    """Minimum racing line wetness (0.0 to 1.0)."""
    max_path_wetness: float = 0.0
    """Maximum off-line wetness (0.0 to 1.0)."""
